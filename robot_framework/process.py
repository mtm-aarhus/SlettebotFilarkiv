...
def process(orchestrator_connection: OrchestratorConnection, queue_element: QueueElement | None = None) -> None:
    ...
    def DeleteFromFilarkiv(FilArkivUrl, CaseID, Filarkiv_access_token ):
        Filarkiv_access_token = GetFilarkivToken(orchestrator_connection)
    ...
    FileIDs = GetFileID(FilArkivUrl, CaseID)
    RunPost = DeleteFromFilarkiv(FilArkivUrl =FilArkivUrl, CaseID=CaseID, Filarkiv_access_token= Token)
    if RunPost:
